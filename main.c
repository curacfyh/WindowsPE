...
//    FILE *outFile = fopen("C:\\Users\\Administrator\\Desktop\\sharedDLL_new.dll", "wb");
    FILE *outFile = fopen("D:\\逆向破解\\PE学习\\IPMSG2007_new.exe", "wb");
    if (outFile == NULL) {
...
int main() {
    readFile("D:\\逆向破解\\PE学习\\IPMSG2007.exe");
